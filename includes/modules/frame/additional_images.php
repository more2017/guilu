...
if ($num_images) {
  ...
  for ($i=0, $n=$num_images; $i<$n; $i++) {
    ...
    $thumb_slashes = zen_image($base_image, addslashes($products_name), 62, 55);
    $thumb_regular = zen_image_products_info($base_image, $products_name, 62, 55);
    $large_link = zen_href_link(FILENAME_POPUP_IMAGE_ADDITIONAL, 'pID=' . $_GET['products_id'] . '&pic=' . $i . '&products_image_large_additional=' . $products_image_large);

    // Link Preparation:
    $noscript_link = '<li><a href="' . $products_image_large . '" data-imagelightbox="f">' . $thumb_regular . '</a></li>';
