...
<?php echo zen_js_zone_list('SelectedCountry', 'theForm', 'zone_id'); ?>
  ...
  function showStateField(theForm) {
    ...
    theForm.state.className = 'inputLabel visibleField form-control';
    theForm.state.setAttribute('className', 'visibleField');
    document.getElementById("stateLabel").className = 'inputLabel visibleField form-control';
    document.getElementById("stateLabel").setAttribute('className', 'inputLabel visibleField form-control');
