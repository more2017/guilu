 ...
 */
  function zen_image_products_info($src, $alt = '', $width = '', $height = '', $parameters = '') {
...
// the image filename as default
    $image = '<img class="img-thumbnail" src="' . zen_output_string($src) . '" alt="' . zen_output_string($alt) . '"';
...
// only use proportional image when image is larger than proportional size
  ...
  function zen_image_main_products_info($src, $alt = '', $width = '', $height = '', $parameters = '') {
    global $template_dir, $zco_notifier;
