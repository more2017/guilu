...
class zen_categories_ul_generator_headers {
...
',
    ...
    {
        $result = sprintf($this->parent_group_start_string, ($submenu==true) ? ' class="dropdown-menu"' : '' );
        
        if (($this->data[$parent_id])) {
            foreach($this->data[$parent_id] as $category_id => $category) {
                $category_link = $parent_link . $category_id;
                if (($this->data[$category_id])) {
                    $result .= sprintf($this->child_start_string, ($submenu==true) ? ' class="dropdown"' : '');
                } else {
